...
class MarsNode: SCNNode {
    ...
    private func setupMars(_ anchor: ARPlaneAnchor) {
    ...
    private func calculatePlanetGeometry(_ anchor: ARPlaneAnchor) {
        ...
        let marsSphere = SCNSphere(radius: CGFloat(size))
        marsSphere.firstMaterial?.diffuse.contents = UIColor.blue
        self.geometry = marsSphere
    }
